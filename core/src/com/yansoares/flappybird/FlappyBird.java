package com.yansoares.flappybird;
...
public class FlappyBird extends ApplicationAdapter {
    ...
    private int estadoJogo = 0; //0-> nao iniciado 1-> iniciado 2-> gameover
    ...
    public void create() {
        ...
        //gameOver = new Texture("game_belinha.png");
    ...
    public void render() {
        ...
        if (estadoJogo == 0) {
            ...
            if (estadoJogo == 1) {
                ...
                rotacaoPassaro = -90;//Quando o jogo entrar no estado gameover muda a rotação

                if (Gdx.input.justTouched()) {
                    rotacaoPassaro = 0;//Ao pressionar novamente, irá zerar a rotação
                    estadoJogo = 0;
                    pontuacao = 0;
                    velocidadeQueda = 0;
                    posicaoInicialVertical = alturaDispositivo / 2;
        ...
        Gdx.app.log("Variacao", "Variacao: " + (int) variacao);

        //configuracoes da camerra
        ...
        sprite.setPosition(120, posicaoInicialVertical);
        sprite.draw(batch);//perceba que é utilizado o mesmo "batch" acima
        ...
        if (estadoJogo == 2) {
            ...
            //mensagem.draw(batch, "Perdeu kkkk\nmas, cadê meu bife?", larguraDispositivo / 2 - 200, alturaDispositivo / 2 - gameOver.getHeight() / 2 + 60);
        }
        batch.end();
